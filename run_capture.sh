#!/bin/bash
# run_capture.sh
# Runs the simulation while capturing traffic to pc# Usage: ./run_capture.sh [classic]
...
PCAP_FILE="sim_traffic_${MODE}.pcap"
HTML_FILE="session_report_${MODE}.html"
...
$SIM 5006 $ENABLE_FD > sim_c.log 2>&1 &
PID_SIM=$!
sleep 1
...
$CLIENT 127.0.0.1 5005 $ENABLE_FD > client_c.log 2>&1
